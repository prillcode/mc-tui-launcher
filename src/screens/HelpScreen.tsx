...
const KEYS: Array<[string, string]> = [
  ...
  ["a / E", "add · edit a server record (Servers)"],
  ["b / v", "back up a server world · toggle its backups (Servers)"],
  ...
  ["Enter", "restore a server backup; a running container is stopped, restored, restarted (Servers)"],
  ["p", "prune old server backups beyond the retention count (Servers backups)"],
